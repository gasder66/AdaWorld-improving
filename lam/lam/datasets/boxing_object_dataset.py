...
class BoxingObjectDataset(Dataset):
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "punch_side_labels": raw.get("punch_side_labels", torch.zeros_like(raw["punch_labels"])).long(),
            "arm_lengths": raw["arm_lengths"].float(),
            "arm_delta": raw.get("arm_delta", raw["arm_lengths"][1:] - raw["arm_lengths"][:-1]).float(),
